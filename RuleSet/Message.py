...
class Message(MidoMessage):
    ...
    def print_dmxc(self):
        print(f"DMXC: channel={self.dmxc_channel}, data1={self.data1}, data2={self.data2}, message={self.message}")
    ...
    def extract_midi_values_from_number(number):
        ...
        # Konvertiere die Zweiergruppen in Dezimalzahlen, einschließlich führender Nulle
